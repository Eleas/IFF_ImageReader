...
IFFReader::BMHD::BMHD()
    : width_{0}, height_{0}, xcoordinate_{0}, ycoordinate_{0},
      bitplanes_{0}, masking_{0}, compression_{0}, transparency_{0},
      x_aspect_ratio_{0}, y_aspect_ratio_{0}, page_width_{0}, page_height_{0} {}
...
const uint16_t IFFReader::BMHD::GetWidth() const { return width_; }

const uint16_t IFFReader::BMHD::GetHeight() const { return height_; }

const uint16_t IFFReader::BMHD::GetBitplanesCount() const { return bitplanes_; }

const uint8_t IFFReader::BMHD::CompressionMethod() const {
  return compression_;
}

const uint8_t IFFReader::BMHD::MaskUsed() const { return masking_; }
